...
本项目使用的`Java`版本是**17.0.16-oracle**,`node`版本为**22.17.1**,`React Native`版本为**0.81.4**,`@dr.pogodin/react-native-fs`版本为**2.35.1**,`lottie-react-native`版本为**7.3.4**,`@react-native-documents/picker`的版本为**10.1.6**,`react-native-screens`的版本为**4.16.0**,`react-native-svg`的版本为**15.13.0**
...
5. 生成发行APK包，`cd android && ./gradlew assembleRelease`，打包详见[Android打包发布](https://reactnative.cn/docs/0.81/signed-apk-android)。